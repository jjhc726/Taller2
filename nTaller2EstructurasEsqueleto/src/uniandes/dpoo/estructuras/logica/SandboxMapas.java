...
public class SandboxMapas {
     ...
     * @return La cadena lexicográficamente menor dentro de las llaves del mapa, o null si el mapa está vacío
     */
    public String getPrimera() {
        if (mapaCadenas.isEmpty()) {
            return null;
        }
        List<String> llavesOrdenadas = new ArrayList<>(mapaCadenas.keySet());
     ...
     * @return La cadena lexicográficamente mayor dentro de los valores del mapa, o null si el mapa está vacío
     */
    public String getUltima() {
        if (mapaCadenas.isEmpty()) {
            return null;
        }
        List<String> valoresOrdenados = getValoresComoLista();
    ...
    public void eliminarCadenaConValor(String valor) {
        mapaCadenas.remove(new StringBuilder(valor).reverse().toString());
    }
    ...
    public void reiniciarMapaCadenas(List<Object> objetos) {
        ...
        for (Object obj : objetos) {
            mapaCadenas.put(new StringBuilder(obj.toString()).reverse().toString(), obj.toString());
        }
    }
