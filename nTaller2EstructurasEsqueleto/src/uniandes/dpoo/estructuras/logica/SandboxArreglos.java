...
public class SandboxArreglos
{
    ...
    {
    	int[] arreglo = new int[arregloEnteros.length+1];
    	
    	for(int i = 0; i< arregloEnteros.length; i++)
    	{
    		arreglo[i] = arregloEnteros[i];
    	}
    	arreglo[arregloEnteros.length] = entero;
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	{
    		arreglo[i] = arregloCadenas[i];
    	}
    	arreglo[arregloCadenas.length] = cadena;
    ...
    public void eliminarEntero( int valor )
    {
    	 int[] nuevoArreglo = new int[arregloEnteros.length];
    	    ...
    	    arregloEnteros = Arrays.copyOf(nuevoArreglo, contador);
    ...
    {
        int[] arreglo = new int[arregloEnteros.length];
        int cont=0;
    	for(int i=0; i < arregloEnteros.length; i++)
    	{
    		if(arregloEnteros[i] == valor)
    ...
    public int[] calcularRangoEnteros( )
    {
        ...
        for (int entero : arregloEnteros) {
            min = Math.min(min, entero);
            max = Math.max(max, entero);
        }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
    	...
    	Arrays.sort(arregloEnteros);
    	boolean resp = compararArregloEnteros(otroArreglo);
    	return resp;
